<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ManageProps.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
              ...
              <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Maintence<br>Requests</span>
                      <div class="progress">
                    ...
                    <div class="number"><strong><asp:Label runat="server" Text="0" ID="lblMainRequestCount"></asp:Label></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="number"><strong><asp:Label runat="server" ID="lblWorkOrders" Text="0"></asp:Label></strong></div>
                  </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
    ...
    <script type="text/javascript" src="js/charts-home.js"></script>
    <script type="text/javascript">
        $(document).ready(function ()
        {
            ShowChartData('#lineCahrt', '#lineChart1', '#pieChart', '#barChartHome');
        });
    </script>
</asp:Content>
