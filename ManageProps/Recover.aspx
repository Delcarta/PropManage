<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recover.aspx.cs" Inherits="ManageProps.Recover" %>
                ...
                <div class="content">
                  <div id="register-form">
                    <div class="form-group">
                      <input id="txtEmail" type="text" name="registerUsername" required class="input-material" runat="server"/>
                      <label for="txtUser" class="label-material">Email</label>
                    </div>
                   
                   
                    <asp:button id="btnReset" type="submit" text="Reset" class="btn btn-primary" OnClick="btnReset_Click" runat="server"/>
                  </div><small>Remember Password? </small><a href="login.aspx" class="signup">Login</a>
                </div>
              </div>
            </div>
          </div>
