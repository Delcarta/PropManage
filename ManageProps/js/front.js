$(document).ready(function () {
    ...
    $('#registerForm').validate({
        messages: {
            ...
            registerFirst: 'please enter your first name',
            registerLast: 'please enter your last name'
        }
    });
    ...
    $('#resetPassword').validate({
        messages: {
            txtPass1: 'please enter your username'
        },
        rules: {
            txtPass1: {required: true},
            txtPass2: { equalTo: '#txtPass1' }
        }
    });
